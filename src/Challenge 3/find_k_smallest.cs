// Dafny program find_k_smallest.dfy compiled into C#
  ...
  decreases env
{
  ...
  if num_arg.Length == 0 || src_file_arg.Length == 0 || dst_file_arg.Length == 0 {
    print ""Usage: dotnet find_k_smallest.dll <number> <sourcefile> <destinationfile>\n"";
    return;
  }
  ...
  if dst_buffer.Length > 2147483647 {
...
namespace _module {
  ...
  public partial class __default {
    public static void _Main(Dafny.ISequence<Dafny.ISequence<char>> __noArgsParameter)
    {
      ...
      _0_n = _out0;
      if ((_0_n) != (4U)) {
        Dafny.Helpers.Print((Dafny.Sequence<char>.FromString("Usage: dotnet find_k_smallest.dll <number> <sourcefile> <destinationfile>\n")));
        return ;
      }
      char[] _1_num__arg;
      char[] _out1;
      _out1 = HostConstants.GetCommandLineArg((ulong)(1UL));
      _1_num__arg = _out1;
      char[] _2_src__file__arg;
      char[] _out2;
      _out2 = HostConstants.GetCommandLineArg((ulong)(2UL));
      _2_src__file__arg = _out2;
      char[] _3_dst__file__arg;
      char[] _out3;
      _out3 = HostConstants.GetCommandLineArg((ulong)(3UL));
      _3_dst__file__arg = _out3;
      if ((((new BigInteger((_1_num__arg).Length)).Sign == 0) || ((new BigInteger((_2_src__file__arg).Length)).Sign == 0)) || ((new BigInteger((_3_dst__file__arg).Length)).Sign == 0)) {
        Dafny.Helpers.Print((Dafny.Sequence<char>.FromString("Usage: dotnet find_k_smallest.dll <number> <sourcefile> <destinationfile>\n")));
        return ;
      }
      char[] _4_src__file;
      char[] _out4;
      _out4 = __default.ConvertCharSeqToCharArray(Dafny.Helpers.SeqFromArray(_2_src__file__arg));
      _4_src__file = _out4;
      char[] _5_dst__file;
      char[] _out5;
      _out5 = __default.ConvertCharSeqToCharArray(Dafny.Helpers.SeqFromArray(_3_dst__file__arg));
      _5_dst__file = _out5;
      bool _6_src__exists;
      bool _out6;
      _out6 = FileStream.FileExists(_4_src__file);
      _6_src__exists = _out6;
      if (!(_6_src__exists)) {
      ...
      bool _7_dst__exists;
      bool _out7;
      _out7 = FileStream.FileExists(_5_dst__file);
      _7_dst__exists = _out7;
      if (_7_dst__exists) {
        Dafny.Helpers.Print((Dafny.Sequence<char>.FromString("Error: Destination file already exists.\n")));
        return ;
      }
      bool _8_src__file__stream__ok;
      FileStream _9_src__file__stream;
      bool _out8;
      FileStream _out9;
      FileStream.Open(_4_src__file, out _out8, out _out9);
      _8_src__file__stream__ok = _out8;
      _9_src__file__stream = _out9;
      if (!(_8_src__file__stream__ok)) {
        Dafny.Helpers.Print((Dafny.Sequence<char>.FromString("Error: Could not open source file.\n")));
        return ;
      }
      bool _10_success__len;
      int _11_src__len;
      bool _out10;
      int _out11;
      FileStream.FileLength(_4_src__file, out _out10, out _out11);
      _10_success__len = _out10;
      _11_src__len = _out11;
      if (!(_10_success__len)) {
      ...
      byte[] _12_src__buffer;
      byte[] _nw0 = new byte[Dafny.Helpers.ToIntChecked(_11_src__len, "array size exceeds memory limit")];
      _12_src__buffer = _nw0;
      bool _13_ok__read;
      bool _out12;
      _out12 = (_9_src__file__stream).Read((int)(0), _12_src__buffer, 0, _11_src__len);
      _13_ok__read = _out12;
      if (!(_13_ok__read)) {
        Dafny.Helpers.Print((Dafny.Sequence<char>.FromString("Error: Unable to read from source file.\n")));
        return ;
      }
      if ((new BigInteger((_12_src__buffer).Length)).Sign == 0) {
        Dafny.Helpers.Print((Dafny.Sequence<char>.FromString("Error: Source file is empty.\n")));
        return ;
      }
      BigInteger[] _14_src__array;
      BigInteger[] _out13;
      _out13 = __default.ConvertByteArrayToIntArray(_12_src__buffer);
      _14_src__array = _out13;
      bool _15_ok__src__close;
      bool _out14;
      _out14 = (_9_src__file__stream).Close();
      _15_ok__src__close = _out14;
      if (!(_15_ok__src__close)) {
        Dafny.Helpers.Print((Dafny.Sequence<char>.FromString("Error: Unable to close source file.\n")));
        return ;
      }
      byte[] _16_dst__buffer;
      byte[] _out15;
      _out15 = __default.ConvertIntArrayToByteArray(_14_src__array);
      _16_dst__buffer = _out15;
      bool _17_dst__file__stream__ok;
      FileStream _18_dst__file__stream;
      bool _out16;
      FileStream _out17;
      FileStream.Open(_5_dst__file, out _out16, out _out17);
      _17_dst__file__stream__ok = _out16;
      _18_dst__file__stream = _out17;
      if (!(_17_dst__file__stream__ok)) {
        Dafny.Helpers.Print((Dafny.Sequence<char>.FromString("Error: Could not open destination file.\n")));
        return ;
      }
      if ((new BigInteger((_16_dst__buffer).Length)) > (new BigInteger(2147483647))) {
        Dafny.Helpers.Print((Dafny.Sequence<char>.FromString("Error: Destination file size is too large.\n")));
        return ;
      }
      if ((new BigInteger((_16_dst__buffer).Length)).Sign == 0) {
        Dafny.Helpers.Print((Dafny.Sequence<char>.FromString("Error: Empty output.\n")));
        return ;
      }
      bool _19_ok__write;
      bool _out18;
      _out18 = (_18_dst__file__stream).Write((int)(0), _16_dst__buffer, 0, (int)(_16_dst__buffer).Length);
      _19_ok__write = _out18;
      if (!(_19_ok__write)) {
        Dafny.Helpers.Print((Dafny.Sequence<char>.FromString("Error: Unable to write to destination file.\n")));
        return ;
      }
      bool _20_ok__dst__close;
      bool _out19;
      _out19 = (_18_dst__file__stream).Close();
      _20_ok__dst__close = _out19;
      if (!(_20_ok__dst__close)) {
        Dafny.Helpers.Print((Dafny.Sequence<char>.FromString("Error: Unable to close destination file.\n")));
        return ;
      }
    ...
    public static BigInteger[] ConvertByteArrayToIntArray(byte[] a)
    {
      ...
      for (BigInteger _23_i = BigInteger.Zero; _23_i < _hi0; _23_i++) {
        ...
        if (((_24_number).Sign != -1) && ((_24_number) <= (new BigInteger(9)))) {
          ...
          if ((new BigInteger((_21_temp).Count)).Sign == 1) {
            BigInteger _25_num;
            _25_num = BigInteger.Zero;
            BigInteger _hi1 = new BigInteger((_21_temp).Count);
            for (BigInteger _26_j = BigInteger.Zero; _26_j < _hi1; _26_j++) {
              _25_num = ((_25_num) * (new BigInteger(10))) + ((_21_temp).Select(_26_j));
            }
      ...
      if ((new BigInteger((_21_temp).Count)).Sign == 1) {
        BigInteger _27_num;
        _27_num = BigInteger.Zero;
        BigInteger _hi2 = new BigInteger((_21_temp).Count);
        for (BigInteger _28_j = BigInteger.Zero; _28_j < _hi2; _28_j++) {
          _27_num = ((_27_num) * (new BigInteger(10))) + ((_21_temp).Select(_28_j));
        }
        _22_result = Dafny.Sequence<BigInteger>.Concat(_22_result, Dafny.Sequence<BigInteger>.FromElements(_27_num));
        _21_temp = Dafny.Sequence<BigInteger>.FromElements();
      }
      BigInteger[] _out20;
      _out20 = __default.ConvertIntSeqToIntArray(_22_result);
      b = _out20;
      b = b;
      return b;
      return b;
    ...
    public static byte[] ConvertIntArrayToByteArray(BigInteger[] a)
    {
      ...
      for (BigInteger _30_i = BigInteger.Zero; _30_i < _hi3; _30_i++) {
        ...
        if ((_31_num).Sign == 0) {
          ...
          _32_digits = Dafny.Sequence<byte>.FromElements();
          while ((_31_num).Sign == 1) {
            _32_digits = Dafny.Sequence<byte>.Concat(Dafny.Sequence<byte>.FromElements((byte)(((byte)(Dafny.Helpers.EuclideanModulus(_31_num, new BigInteger(10)))) + ((byte)(48)))), _32_digits);
            _31_num = Dafny.Helpers.EuclideanDivision(_31_num, new BigInteger(10));
          }
      ...
      byte[] _out21;
      _out21 = __default.ConvertByteSeqToByteArray(_29_temp);
      b = _out21;
      b = b;
      return b;
      return b;
    ...
    public static char[] ConvertCharSeqToCharArray(Dafny.ISequence<char> s)
    {
      char[] a = new char[0];
      char[] _nw2 = Dafny.ArrayHelpers.InitNewArray1<char>('D', Dafny.Helpers.ToIntChecked(new BigInteger((s).Count), "array size exceeds memory limit"));
      a = _nw2;
    ...
    public static BigInteger[] ConvertIntSeqToIntArray(Dafny.ISequence<BigInteger> s)
    {
      ...
      BigInteger[] _nw3 = new BigInteger[Dafny.Helpers.ToIntChecked(new BigInteger((s).Count), "array size exceeds memory limit")];
      a = _nw3;
      BigInteger _hi6 = new BigInteger((s).Count);
      for (BigInteger _35_i = BigInteger.Zero; _35_i < _hi6; _35_i++) {
        (a)[(int)((_35_i))] = (s).Select(_35_i);
      }
      a = a;
      return a;
      return a;
  ...
  public partial class nat32 {
    ...
    public static bool _Is(int __source) {
      BigInteger _36_i = new BigInteger(__source);
      return ((_36_i).Sign != -1) && ((_36_i) < (new BigInteger(2147483648L)));
    }
  }
